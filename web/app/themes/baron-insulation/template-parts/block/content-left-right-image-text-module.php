...
$id = 'left-right-image-text-module-' . $block['id'];
...
<section id="<?php print $id; ?>" class="section whychoose <?php if($background_theme == 'theme-grey'): ?>prodsol<?php endif; ?>">
    ...
    <div class="container">
        <div class="whychoose__row row">
            <div class="whychoose__col col-lg-5">
                <div class="whychoose__media">
                    <img src="<?php echo $image['url'] ?>" alt="<?php echo $image['title'] ?>">
                </div>
            </div>
            <div class="whychoose__col col-lg-7">
                <div class="whychoose__text">
                    <h2 class="whychoose__title"><?php echo $heading; ?></h2>
                    <p><?php echo $blurb; ?></p>
                    <?php if(!empty($links)): ?>
